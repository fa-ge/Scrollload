...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__requestAnimationFrame_js__ = __webpack_require__(54);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__assign_js__ = __webpack_require__(53);
...
var Scrollload = function () {
    function Scrollload(container, options) {
    ...
    _createClass(Scrollload, [{
        ...
        value: function scrollListener() {
            ...
            requestAnimationFrame(function () {
                ...
                var loadMoreFn = _this._options.loadMoreFn;

                if (_this.isBottom()) {
                    _this.isLock = true;
                    if (loadMoreFn) {
                        loadMoreFn.call(_this, _this);
                    }
                }
            });
        }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__loading_css__ = __webpack_require__(58);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_swiper_dist_js_swiper_min__ = __webpack_require__(72);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6_Scrollfixplus__ = __webpack_require__(55);
...
var scrollloads = [];
Array.from($$('.tab')).forEach(function (tab, index) {
    scrollloads.push(new __WEBPACK_IMPORTED_MODULE_1__Scrollload__["a" /* default */](tab, {
        window: $$('.window')[index],
        ...
        loadMoreFn: function loadMoreFn(sl) {
            setTimeout(function () {
                sl.count = sl.count || 0;
                if (sl.count++ < 5) {
...
var swiperContainerHeight = $('.swiper-container').clientHeight;
