...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_localscrollfix_src_LocalScrollFix__ = __webpack_require__(31);
...
var scrollload = new __WEBPACK_IMPORTED_MODULE_1__Scrollload__["a" /* default */](document.querySelector('.container'), function (sl) {
    ...
    //在ios使用局部滚动，其他使用全局滚动
    window: isIos() ? document.querySelector('.window') : (Array.from(document.querySelectorAll('.full-height')).forEach(function (value) {
        return value.classList.remove('full-height');
    }), window),
    //如果你的设备不是苹果手机，以下两个属性不会生效
